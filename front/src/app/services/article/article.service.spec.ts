...
describe('ArticleService', () => {
  ...
  it('should retrieve all articles', () => {
    const dummyArticles: Article[] = [
      { id: '1', title: 'Test Article 1', date: '2020-01-01', author: 'Author 1', theme: 'Theme 1', content: 'Content 1' },
      { id: '2', title: 'Test Article 2', date: '2020-01-02', author: 'Author 2', theme: 'Theme 2', content: 'Content 2' }
    ];
  ...
  it('should find an article by ID', () => {
    const dummyArticle: Article = { id: '1', title: 'Test Article', date: '2020-01-01', author: 'Author', theme: 'Theme', content: 'Content' };
  ...
  it('should retrieve comments for an article', () => {
    const dummyComments: ArticleComment[] = [
      { id: '1', content: 'Comment 1', date: new Date('2020-01-01'), username: 'User 1' },
      { id: '2', content: 'Comment 2', date: new Date('2020-01-02'), username: 'User 2' }
    ];
    ...
    const req = httpController.expectOne(`${service['apiUrl']}/articles/1/comments`);
    expect(req.request.method).toBe('GET');
    req.flush(dummyComments);
  });

  it('should post a new comment to an article', () => {
    const newComment: ArticleComment = { id: '3', content: 'New comment', date: new Date(), username: 'New User' };

    service.addCommentToArticle('1', { content: 'New comment' }).subscribe(comment => {
